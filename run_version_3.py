...
def main(args):
    ...
    env = ProbDistEnv(ASRSEnv(eval(args.storage_shape), origin_coord=eval(args.exit_coord), dist_param = eval(args.dist_param)))

    env_name = env.__name__
    exp_dir = os.getcwd() + '/data/version3/%s/policy_type%s_envsize_%s/' % (env_name, args.policy_type,np.array(eval(args.storage_shape)).prod())
...
[0.1, 0.11, 0.14, 0.18, 0.22, 0.26, 0.3 , 0.34, 0.38, 0.42, 0.46, 0.5, 0.52,
       0.54, 0.58, 0.62, 0.66, 0.7 , 0.74, 0.78, 0.82, 0.86, 0.9 , 0.94,
       0.98]
